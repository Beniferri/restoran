...
$this->menu=array(
	array('label'=>Yii::t('global','Daftar').' User', 'url'=>array('view'),'visible'=>UserAccess::ruleAccess('read_p')),
	array('label'=>Yii::t('global','Tambah').' User', 'url'=>array('create'), 'visible'=>UserAccess::ruleAccess('create_p')),
);
...
<div class="panel panel-info">
	<div class="panel-heading">
		<h4 class="panel-title"><?php echo Yii::t('global','Daftar');?> Users</h4>
	</div>
