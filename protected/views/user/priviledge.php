...
<div class="panel panel-info">
	...
	<div class="panel-body">
		...
		<?php $form = $this->beginWidget('CActiveForm',array('htmlOptions'=>array('name'=>'userrbac'))); ?>
			...
			<br class="clear"/>
			<?php echo CHtml::submitButton(Yii::t('global','Simpan'),array('style'=>'min-width:100px;','id'=>'btn-submit','disabled'=>'disabled','class'=>'tombol simpan')); ?>
			<a href="http://localhost/restoran/user/view" class="btn btn-warning">Batal</a>
		<?php $this->endWidget(); ?>
		</div>
	</div>
</div>
