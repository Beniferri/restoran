...
<p class="note"><b>Catatan:</b> tanda <strong style="color:red">*</strong> harus diisi.</p><br>
	...
	<div class="form-group col-md-12">
		<?php echo CHtml::submitButton($model->isNewRecord ? 'Simpan' : 'Simpan', array('style'=>'min-width:100px;')); ?>
		<a href="http://localhost/restoran/user/view" class="btn btn-danger">Batal</a>
	</div>
