		...
		<?php if(!Yii::app()->user->isGuest):?>
            <div class="navbar-header">
                ...
                <ul class="nav navbar-nav navbar-left-custom">
                    ...
                    <li><a class="nav-icon sidebar-toggle" ><i class="fa fa-bars"></i><i class="serif"> 
                    		<?php
...
<div class="container-fluid">
	<div class="page-header">
            ...
            <?php if (UserAccess::hasAccess('tagihan', Yii::app()->user->id, 'read_p')):?>
                <li>
					<a href="<?php echo Yii::app()->createUrl('/tagihan/view');?>" class="btn btn-info">
						<i class="fa fa-money"></i> <span>Daftar Tagihan</span>
					</a>
				...
				<li>
					<a href="<?php echo Yii::app()->createUrl('/');?>" class="btn btn-danger">
