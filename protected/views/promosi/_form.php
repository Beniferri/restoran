...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<p class="note"><b>Catatan:</b> tanda <strong style="color:red">*</strong> harus diisi.</p><br><br>
	...
	<div class="form-group col-md-4">
		...
		<?php echo $form->textArea($model,'deskripsi',array('rows'=>1, 'cols'=>50)); ?>
	...
	<div class="form-group col-md-12 buttons">
		...
		<a href="http://localhost/restoran/promosi/view" class="btn btn-danger">Batal</a>
	</div>
