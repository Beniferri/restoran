...
<div class="row">
		...
		<div class="panel-body">
			...
			<div class="tab-content pill-content">
				<div id="detail-invoice" class="tab-pane active">
					...
					<div class="col-sm-4">
						<div class="dropdown widget clearfix">
							<ul class="dropdown-menu" style="display: block; position: static; border-color: #3C9AC9;" role="menu">
				...
				<div id="update-invoice" class="tab-pane">
					...
					<div class="form-group col-sm-4">
						<?php echo $form->label($model,'Tanggal Input',array('class'=>'control-label')); ?>
						<?php
					...
					<div class="form-group col-sm-12">Data Items :</div>
				...
				<?php $this->widget('zii.widgets.grid.CGridView', array(
					...
					<div class="form-group col-sm-12">
						<?php echo CHtml::submitButton(Yii::t('global','Simpan'),array('class'=>'btn btn-primary','style'=>'min-width:100px;')); ?>
						<a href="http://localhost/restoran/tagihan/view" class="btn btn-danger">Batal</a>
					</div>
	...
	<div class="panel panel-info">
		<div class="panel-heading">
			<h4 class="panel-title"><?php echo Yii::t('global','Tagihan items');?></h4>
		</div>
		<div class="panel-body">
			<div class="table-responsive">
						...
						<table class="table table-striped mb10">
							<thead>
								<tr>
									...
									<th><?php echo Yii::t('order','Jumlah');?></th>
...
<div id="myModal" class="modal fade" aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<button class="btn btn-primary" id="btn-print" type="button">Cetak</button>
			</div>
		</div>
	</div>
</div>
