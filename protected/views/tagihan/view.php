...
<!-- <ul class="row stats">
	...
	<li class="col-xs-3">
		...
		<span><?php echo Yii::t('order','Refund Tagihan');?></span>
	</li>
	<li class="col-xs-3">
...
<div class="panel panel-info">
	<div class="panel-heading">
		<h4 class="panel-title"><?php echo Yii::t('global','Daftar');?> <?php echo Yii::t('order','Tagihan');?></h4>
	</div>
	<div class="panel-body">
		<?php echo CHtml::link(Yii::t('global','Pencarian'),'#',array('class'=>'search-button pull-right btn btn-default-alt')); ?>
		<ul class="nav nav-tabs">
			<li class="">
				<a data-toggle="tab" href="#paid-invoice">
					<strong><?php echo Yii::t('order','Tagihan Terbayar');?></strong> <span class="badge badge-warning"><?php echo $paidProvider->totalItemCount;?></span>
				</a>
			</li>
			<li class="">
				<a data-toggle="tab" href="#unpaid-invoice">
					<strong><?php echo Yii::t('order','Tagihan Blm Terbayar');?></strong> <span class="badge badge-warning"><?php echo $unpaidProvider->totalItemCount;?></span>
				</a>
			</li>
			<li class="">
				<a data-toggle="tab" href="#refund-invoice">
					<strong><?php echo Yii::t('order','Tagihan Refund');?></strong> <span class="badge badge-warning"><?php echo $refundProvider->totalItemCount;?></span>
				</a>
			</li>
			<li class="active">
				<a data-toggle="tab" href="#all-invoice">
					<strong><?php echo Yii::t('order','Semua Tagihan');?></strong> <span class="badge badge-warning"><?php echo $dataProvider->totalItemCount;?></span>
				</a>
			</li>
		</ul>
