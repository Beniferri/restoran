...
<div class="tab-content pill-content">
	...
	<p class="note"><b>Catatan:</b> tanda <strong style="color:red">*</strong> harus diisi.</p><br>
...
<div class="form-group col-md-12 mt10">
	<?php echo CHtml::submitButton($model->isNewRecord ? Yii::t('global','Simpan') : Yii::t('global','Simpan'),array('style'=>'min-width:100px;')); ?>
	<a href="http://localhost/restoran/produk/view" class="btn btn-danger">Batal</a>
</div>
<?php $this->endWidget(); ?>